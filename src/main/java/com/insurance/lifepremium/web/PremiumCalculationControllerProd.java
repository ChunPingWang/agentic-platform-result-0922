...
import com.insurance.lifepremium.application.service.PremiumCalculationServiceProd;
...
@Profile("!test")
public class PremiumCalculationControllerProd {

    private final PremiumCalculationServiceProd calculationService;

    public PremiumCalculationControllerProd(PremiumCalculationServiceProd calculationService) {
