...
import com.insurance.lifepremium.infrastructure.cache.NoOpRateCacheService;
...
public class PremiumCalculationService {
    ...
    private final NoOpRateCacheService rateCacheService;

    public PremiumCalculationService(RateTableService rateTableService,
                                     CalculationRecordRepository calculationRecordRepository,
                                     NoOpRateCacheService rateCacheService) {
